...
import PaperAirplaneIcon from '@/components/SVGIcon/PaperAirplaneIcon';
      ...
      >
        ...
        >
          <h1 className="text-xl flex items-center gap-2 mb-2 font-semibold">
            <PaperAirplaneIcon className="w-[24px] animate-[swing_3s_ease-in-out_infinite] origin-bottom-right" />
            登录
          </h1>
